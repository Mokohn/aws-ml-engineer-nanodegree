...
def main():
    ...
    transform = transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.1307,), (0.3081,))])  # TODO: Create your transform
    ...
    optimizer = optim.Adadelta(model.parameters(), lr=args.learning_rate)  # TODO: Add your optimizer
